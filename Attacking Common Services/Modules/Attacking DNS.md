...
Attacking DNS  
```
Pavlo142@htb[/htb]# nmap -p53 -Pn -sV -sC 10.10.110.213
...
Attacking DNS  
```
Pavlo142@htb[/htb]# dig AXFR @ns1.inlanefreight.htb inlanefreight.htb
...
Attacking DNS  
```
Pavlo142@htb[/htb]# fierce --domain zonetransfer.me
...
Attacking DNS  
```
Pavlo142@htb[/htb]# ./subfinder -d inlanefreight.com -v       
...
Attacking DNS  
```
Pavlo142@htb[/htb]$ git clone https://github.com/TheRook/subbrute.git >> /dev/null 2>&1
Pavlo142@htb[/htb]$ cd subbrute
Pavlo142@htb[/htb]$ echo "ns1.inlanefreight.com" > ./resolvers.txt
Pavlo142@htb[/htb]$ ./subbrute.py inlanefreight.com -s ./names.txt -r ./resolvers.txt
...
Attacking DNS  
```
Pavlo142@htb[/htb]# host support.inlanefreight.com
...
![This X ML file does not andar to have any shie information associated with it, The document tree is shown below.](Attachments/E836AC1F-ED50-41CB-8A08-FD61A0788C32.png)  
...
Attacking DNS  
```
Pavlo142@htb[/htb]# cat /etc/ettercap/etter.dns
...
![Host List X](Attachments/9C3C902C-360B-4A0E-8DEF-7EA2E947A538.png)  
Activate ****dns_spoof**** attack by navigating to ****Plugins > Manage Plugins****. This sends the target machine with fake DNS responses that will resolve ****inlanefreight.com**** to IP address ****192.168.225.110****:  
![Report suspicious ARP actvity](Attachments/9075B96B-8030-46C9-87AA-C6EAF76F40D6.png)  
After a successful DNS spoof attack, if a victim user coming from the target machine ****192.168.152.129**** visits the ****inlanefreight.com**** domain on a web browser, they will be redirected to a ****Fake page**** that is hosted on IP address ****192.168.225.110****:  
![Fake page](Attachments/600748E7-76A5-4720-B000-E2FA5D245666.png)  
