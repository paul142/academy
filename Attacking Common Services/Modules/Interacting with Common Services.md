...
![1 Windows Server 2012 R2](Attachments/BE05981E-876F-418D-953F-BCF34BB55284.jpg)  
...
![Windows Server 2012 R2 Standars](Attachments/A8D3FA8A-8707-4473-8C40-E11D1E10A693.jpg)  
If we do not have access, we will receive an authentication request.  
![Windows Security](Attachments/FF2B21EC-4C90-4491-8412-0318D1A7C8D2.jpg)  
...
```
```
PS C:\htb> New-PSDrive -Name "N" -Root "\\192.168.220.129\Finance" -PSProvider "FileSystem" -Credential 
```
```
$cred
...
Interacting with Common Services  
```
Pavlo142@htb[/htb]$ sudo mkdir /mnt/Finance
Pavlo142@htb[/htb]$ sudo mount -t cifs -o username=plaintext,password=Password123,domain=. //192.168.220.129/Finance /mnt/Finance
...
Interacting with Common Services  
```
Pavlo142@htb[/htb]$ mount -t cifs //192.168.220.129/Finance /mnt/Finance -o credentials=/path/credentialfile
...
Interacting with Common Services  
```
Pavlo142@htb[/htb]$ find /mnt/Finance/ -name *cred*
...
Interacting with Common Services  
```
Pavlo142@htb[/htb]$ grep -rn /mnt/Finance/ -ie cred
...
Interacting with Common Services  
```
Pavlo142@htb[/htb]$ sudo apt-get install evolution
...SNIP...
...
![ConnectToIMAPandSMTP.jpg](Attachments/08A62B36-AD36-46F5-9684-EAE8374D1AA3.jpg)  
...
****MySQL example****  
![MySQL Database](Attachments/3E68B419-8559-4AF6-AB39-C7D477062D32.png)  
...
Interacting with Common Services  
```
Pavlo142@htb[/htb]$ sqsh -S 10.129.20.13 -U username -P Password123
...
Interacting with Common Services  
```
Pavlo142@htb[/htb]$ mysql -u username -pPassword123 -h 10.129.20.13
...
Interacting with Common Services  
```
Pavlo142@htb[/htb]$ sudo dpkg -i dbeaver-<version>.deb
...
![Wwwlt Se sol Server Conterlien se inet](Attachments/25D85A70-CAD2-4CCD-ACB4-009ABD327291.jpg)  
...
![ConnectToMYSQL.jpg](Attachments/FA1D16A9-CDD0-43BE-9F3C-05EF1AC6BC48.jpg)  
